...
class AppConfig:
    ...
    below_player_close_target_max_y_ratio: float = 0.025
    ...
    max_bucket_coefficient: float = 2.35
    min_initial_press_coefficient: float = 1.55
    max_initial_press_coefficient: float = 2.05
