...
class AppConfig:
    ...
    max_coefficient_change_ratio: float = 0.22
    ...
    distance_bucket_size: int = 5
    min_bucket_samples: int = 1
    bucket_learning_rate: float = 0.4
    max_interpolation_gap: float = 25.0
    min_bucket_coefficient: float = 1.45
    max_bucket_coefficient: float = 3.1
    min_initial_press_coefficient: float = 1.75
    max_initial_press_coefficient: float = 2.8
